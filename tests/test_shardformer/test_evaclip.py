...
from cornstarch.shardformer.policies.evaclip import EvaCLIPVisionModelPolicy
...
class TestCLIPVisionModelPolicyClass(PolicyTestBase):
    ...
    def test_hybrid_parallel(
        ...
        with patch(
            ...
            return_value=EvaCLIPVisionModelPolicy(),
        ):
            (
                org_model,
                org_optimizer,
                ...
                model_fn=lambda: EvaCLIPVisionModel(
                    EvaCLIPVisionConfig(num_hidden_layers=4)
                ),
        ...
        shard_clip_model = unwrap_model(sharded_model, "EvaCLIPVisionModel", "model")
