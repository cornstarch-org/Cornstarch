...
@instantiate_parametrized_tests
class TestMixtralModelPolicyClass(ColossalaiHybridParallelBase):
    ...
    def test_hybrid_parallel(
        ...
        self.set_model(MixtralModelBase())
...
@instantiate_parametrized_tests
class TestMixtralForCausalLMPolicyClass(ColossalaiHybridParallelBase):
    @parametrize("tp_size, pp_size", [(4, 1), (1, 1), (2, 2), (1, 4)])
    @parametrize("fa", [True, False])
    @parametrize("precision", ["bf16", "fp16"])
    def test_hybrid_parallel(
        ...
        self.set_model(MixtralForCausalLMBase())
        self.run_hybrid_parallel(tp_size, pp_size, None, fa, precision)
