...
from ._utils import CornstarchMultimodalParallelBase, clip_config, mistral_config


@instantiate_parametrized_tests
class ClipMistralForCausalLMPolicyTestClass(CornstarchMultimodalParallelBase):
    model_class = {
