...
class ClipPhi3ForCausalLMPolicyTestClass(VisionLanguagePolicyTestClassBase):
    vision_model_class = CLIPVisionModel
    language_model_class = Phi3ForCausalLM
    vision_config: CLIPVisionConfig = config_class_dict["clip_vision_model"]
    language_config: Phi3Config = config_class_dict["phi3"]
    ...
    def check_fn(
        ...
        language_row_layer_for_check = ["layers[0].self_attn.qkv_proj", "embed_tokens"]
...
instantiate_parametrized_tests(ClipPhi3ForCausalLMPolicyTestClass)
