...
class ClipGemma2ForCausalLMPolicyTestClass(VisionLanguagePolicyTestClassBase):
    ...
    language_model_class = Gemma2ForCausalLM
    vision_config: CLIPVisionConfig = config_class_dict["clip_vision_model"]
    language_config: Gemma2Config = config_class_dict["gemma2"]
...
instantiate_parametrized_tests(ClipGemma2ForCausalLMPolicyTestClass)
