...
class ClipQwen2ForcausalLMPolicyTestClass(VisionLanguagePolicyTestClassBase):
    vision_model_class = CLIPVisionModel
    language_model_class = Qwen2ForCausalLM
    vision_config: CLIPVisionConfig = config_class_dict["clip_vision_model"]
    language_config: Qwen2Config = config_class_dict["qwen2"]
...
instantiate_parametrized_tests(ClipQwen2ForcausalLMPolicyTestClass)
