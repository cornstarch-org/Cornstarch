...
from cornstarch.models.intern_vit import InternVisionModel
...
def pretrain(
    ...
    model: MultimodalLanguageModel = (
        MultimodalLanguageModel.from_encoders_llm_pretrained(
            ...
            vision_model_name_or_path="OpenGVLab/InternViT-6B-448px-V1-5",
            vision_model_cls=InternVisionModel,
        ).to(dtype=torch.bfloat16, device="cuda")
    )
    model.gradient_checkpointing_enable()

    # Create a processor
    # ImageProcessor configuration from https://huggingface.co/OpenGVLab/InternViT-6B-448px-V1-5
    ...
    torch.save(model.vision_model.projection, "internvit_gemma_vision_projection.pth")
