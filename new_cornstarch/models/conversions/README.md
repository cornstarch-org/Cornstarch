...
6. Register the converter in `new_cornstarch.models.hf_conversion.from_hf_config`
   and export it from `new_cornstarch.models.conversions`.
7. Add focused integration coverage in `new_tests/model/test_model_conversion.py`
   and materialization coverage in `new_tests/model/test_model_materialization.py`.
