...
class MistralPipelineForwards:
    ...
    def mistral_model_forward(
        ...
        if use_cache:
            logger.warning_once(
                "use_cache=True is not supported for Mistral models at the moment."
            )
            use_cache = False
        ...
        # retrive input_ids and inputs_embeds
...
class MistralForwards:
    @staticmethod
    def mistral_model_forward_for_flash_attention(
        self: MistralModel,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
    ...
    def mistral_flash_attention_forward(
        self: Union[MistralAttention, MistralSdpaAttention],
    ...
    def mistral_for_causal_lm_forward_with_dist_cross_entropy(
        self: MistralForCausalLM,
        input_ids: torch.LongTensor = None,
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
